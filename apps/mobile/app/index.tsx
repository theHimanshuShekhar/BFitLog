...
export default function HomeScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.description}>Track body weight locally and sync when the server is reachable.</Text>
      ...
      <View style={styles.card}>
        ...
        {status === 'checking' ? (
          ...
          <Text style={styles.status}>{status === 'online' ? 'Online' : 'Offline / unreachable'}</Text>
        )}
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.status}>
          {latestLog ? `${latestLog.weightKg.toFixed(1)} kg` : 'No body weight logged yet'}
        </Text>
      </View>
